...
public class NBody
{
	private static final int secondInTimeStep = 1;//used to calculate velocity and position
	private static final int FramePerSecond = 50;//how long the body sleeps
